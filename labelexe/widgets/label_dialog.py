...
class LabelDialog(QtWidgets.QDialog):
    def __init__(
        ...
        self.culture.setValidator(labelexe.utils.labelValidator())
        ...
        bb.button(bb.Ok).setIcon(labelexe.utils.newIcon("done"))
        bb.button(bb.Cancel).setIcon(labelexe.utils.newIcon("undo"))
