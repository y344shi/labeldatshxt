...
# Polygon drawing.######################################################################################################
        ...
        if QtCore.Qt.LeftButton & ev.buttons():
            if self.selectedVertex():
                #self.selectedShapes=self.shapesBackups
        ...
        for shape in reversed([s for s in self.shapes if self.isVisible(s)]):
            ...
            if index is not None:
                ...
                self.prevhEdge = self.hEdge = index_edge
                self.setToolTip(
                    self.tr("Click & drag to move shape '%s'") % shape.culture
                )
                self.setStatusTip(self.toolTip())
...
######################################################################################################################
    ...
    def closeEnough(self, p1, p2):
        ...
        return labelexe.utils.distance(p1 - p2) < (self.epsilon / self.scale)
    ...
    def intersectingEdges(self, point1, point2, points):
        ...
        for i in range(4):
            ...
            if 0 <= ua <= 1 and 0 <= ub <= 1:
                ...
                d = labelexe.utils.distance(m - QtCore.QPoint(x2, y2))
                yield d, i, (x, y)
    ...
    def setLastLabel(self, text=None, flags=None):
        #assert text
