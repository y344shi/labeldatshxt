...
from labelexe.widgets import BrightnessContrastDialog
...
from labelexe.widgets import checkbox_own
...
################################found where right side widgets are added################################
        ####### FD_0 #######
         ###################################################   my own
...
####################################################################
    ...
    def saveLabels(self, filename):
        ...
        print('checkpoint2-0')
        themes = self.theme_widget.read_boxes()   ##########wuliwa
        print(themes, '\n check')
    ...
    def loadFile(self, filename=None):
        ...
        if QtCore.QFile.exists(label_file) and LabelFile.is_label_file(
            ...
            self.theme_widget.update_boxes(self.labelFile.themes) ########wuliwa
            self.theme_widget.set_original(self.labelFile.themes)
